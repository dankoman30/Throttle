...
#define KILL_RELAY_Pin GPIO_PIN_4
#define KILL_RELAY_GPIO_Port GPIOA
#define BATT_SENSE_Pin GPIO_PIN_6
#define BATT_SENSE_GPIO_Port GPIOA
#define LED_RED_Pin GPIO_PIN_7
#define LED_RED_GPIO_Port GPIOA
#define LOCAL_START_BTN_Pin GPIO_PIN_0
#define LOCAL_START_BTN_GPIO_Port GPIOB
#define STARTER_RELAY_Pin GPIO_PIN_1
#define STARTER_RELAY_GPIO_Port GPIOB
#define LED_GREEN_Pin GPIO_PIN_8
#define LED_GREEN_GPIO_Port GPIOA
#define AUX1_OUT_Pin GPIO_PIN_9
